...
export const DISCLAIMERS: DisclaimerMap = {
  fitness: {
    en: {
 ...
 */
export function getDisclaimer(domain: Domain, length: DisclaimerLength = 'short', locale: Locale = 'en'): string {
  const domainDisclaimers = DISCLAIMERS[domain];
